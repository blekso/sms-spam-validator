...
export default {
  ...
  methods: {
    ...
    async getValidation(){
      ...
      const res = await this.$axios.$post('/workspaces/cdef93b81c194d23b631e9efdb6af565/services/ad000ea1767a49d083be747b4a1cb55b/execute?api-version=2.0&details=true', {"Inputs": {
          "input1": {
            "ColumnNames": [
              "v1",
              "v2"
